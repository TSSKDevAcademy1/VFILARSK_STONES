...
public class ConsoleUI implements Serializable {
	...
	public void processInput() throws WrongInputException {
		System.out.println(
				"Vyber volbu: new pre novu hru,save pre ulozenie,exit pre ukoncenie,best pre najlepsie casy, w s a d pre ovladanie");
		String line;
		try {
			line = input.readLine();
			if ((line == "new" || line == "exit" || line == "w" || line == "s" || line == "a" || line == "d"
					|| line == "w" || line == "w")) {
